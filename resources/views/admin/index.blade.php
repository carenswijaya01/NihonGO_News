...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="kategori" viewBox="0 0 16 16">
    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-primary" style="width: 280px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                ...
                <img src="assets/images/logo_NNews.svg" alt="" />
                <!-- <span class="fs-4">Halaman Admin</span> -->
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <!-- <li class="nav-item">
                    <a href="/admin/beranda" target="iframe_a" class="nav-link text-white">
                ...
                <li class="nav-item">
                    <a href="/admin/berita" target="iframe_a" class="nav-link text-white">
                        <svg class="bi me-2" width="16" height="16">
                ...
                <li>
                    <a href="/admin/kategori" target="iframe_a" class="nav-link text-white">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#kategori" />
                        </svg>
                        Kelola Kategori
                    </a>
                </li>
        ...
        <iframe src="/admin/berita" name="iframe_a" height="auto" width="100%"></iframe>
    </main>
